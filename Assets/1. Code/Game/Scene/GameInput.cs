...
public partial class @GameInput : IInputActionCollection2, IDisposable
{
    ...
    private IMCQMappingActions m_MCQMappingActionsCallbackInterface;
    ...
    public struct MCQMappingActions
    {
        ...
        {
            if (m_Wrapper.m_MCQMappingActionsCallbackInterface != null)
            {
                @OptionBottom.started -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionBottom;
                @OptionBottom.performed -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionBottom;
                @OptionBottom.canceled -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionBottom;
                @OptionRight.started -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionRight;
                @OptionRight.performed -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionRight;
                @OptionRight.canceled -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionRight;
                @OptionTop.started -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionTop;
                @OptionTop.performed -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionTop;
                @OptionTop.canceled -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionTop;
                @OptionLeft.started -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionLeft;
                @OptionLeft.performed -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionLeft;
                @OptionLeft.canceled -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionLeft;
                @OptionMisc.started -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionMisc;
                @OptionMisc.performed -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionMisc;
                @OptionMisc.canceled -= m_Wrapper.m_MCQMappingActionsCallbackInterface.OnOptionMisc;
            }
            m_Wrapper.m_MCQMappingActionsCallbackInterface = instance;
            if (instance != null)
            {
